    ...
    <>
      ...
      >
        ...
        <div className="relative mx-auto flex px-5 md:px-14 py-52 md:flex-row flex-col items-center">
          <div
            className="md:w-full lg:w-[94%] xl:w-3/4 lg:pr-24 md:pr-10 flex flex-col items-center md:items-start md:text-left mb-5 md:mb-0"
            data-aos="fade-right"
          >
            <h1 className="title-font text-2xl md:text-4xl uppercase mb-4 flex flex-col font-normal text-gray-200">
              Hello, I'm
              <span className="mt-2 text-[#2a49ff] text-[2rem] md:text-[3.5rem] tracking-wide font-semibold md:font-bold">
                Rimsha Arfeen,
              </span>
                <span className="mt-2 flex f items-center md:items-start" >a Passionate{""}
                  </span>
              <h5 className="mt-2 flex f items-center md:items-start">
                <span
                  id="element"
                  className=" text-[#2a49ff] text-[2rem] md:text-[3.5rem] tracking-wide font-semibold md:font-bold ml-1 flex"
                ></span>
              </h5>
            </h1>
          ...
          {/* Social Icons */}
          <div
            className="md:w-[25%] w-1/2 mx-auto"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <span className="flex gap-4 flex-wrap justify-center md:flex-col md:items-end h-[14rem]">
              <a
                href="https://www.linkedin.com/in/rimsha-arfeen-b25709305/"
                className="text-[#2a49ff]"
                aria-label="LinkedIn"
                target="_blank"
              ...
              <a
                href="https://github.com/RimshaArfeen"
                className="text-[#2a49ff]"
                aria-label="GitHub"
                target="_blank"
                rel="noopener noreferrer"
