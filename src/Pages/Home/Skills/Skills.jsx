...
const ProgressBar = ({ name, width }) => (
  <div className="flex flex-col w-[85%] mb-7">
    <div className="w-full flex justify-between">
      <span className="mb-1 uppercase leading-relaxed text-lg tracking-wide">{name}</span>
...
const ServiceItem = ({ iconPath, title, description }) => (
  <div className="w-full lg:pr-10 mb-3 px-3 md:px-0">
    <div className="flex relative pb-6">
      ...
      <div className="flex-shrink-0 w-8 md:w-12 h-8 md:h-12 rounded-full bg-indigo-700 inline-flex items-center justify-center text-white relative z-10">
...
lg:pr-5">
  ...
  <div className="flex flex-col ml-8 md:ml-0 w-full items-center  ">
    <a href="/assets/resume.pdf" download className="inline-flex items-start text-white border border-indigo-600 py-2 px-6 focus:outline-none hover:bg-[#1f1f1f79] rounded mb-4 capitalize transition duration-200 text-lg ">
